        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    <h5 class="fw-bold py-3 mb-0"><span class="text-muted fw-light">Manajemen Dokter /</span> Info Dokter</h5>
                    <h3 class="fw-bold py-2 mb-3">Data Dokter</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" name="nama_dokter" value="<?= $data['nama_dokter']; ?>" required disabled>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
						                ...
						                <input type="text" class="form-control" name="sip" value="<?= $data['sip']; ?>" required disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="masa_berlaku">Masa Berlaku</label>
                                        <input type="date" class="form-control" name="masa_berlaku" value="<?= $data['masa_berlaku']; ?>" required disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="spesialis">Spesialisasi</label>
                                        <select class="form-select" id="spesialis" name="spesialis" disabled>
                                            <option value="<?= $data['spesialis']; ?>" hidden><?= $data['spesialis']; ?></option>
                                        </select>
                                    </div>
                                    <div class="mb-3">
                                        <label for="alamat_dokter">Alamat Dokter</label>
                                        <textarea name="alamat_dokter" class="form-control" disabled><?= $data['alamat_dokter']; ?></textarea>
                                    </div>
                                    <div class="mb-3">
