<?php 
    ...
    if (isset($_POST['submit'])) {
        $nama_dokter = ucwords(strtolower($_POST['nama_dokter']));
        ...
        if (mysqli_fetch_assoc($result)) {
            ...
            $(document).ready(function() {
                Swal.fire({
                    text: "Dokter Gagal ditambahkan!, Email Telah Digunakan!",
                    icon: "error",
                    ...
                    if (result.isConfirmed) {
                        window.location.href = "auth-register-dokter.php";
                    }
                })
            });
            </script>';
        ...
        if ($password !== $password2) {
            ...
            $(document).ready(function() {
                Swal.fire({
                    text: "Dokter Gagal ditambahkan!, Konfirmasi Password Salah!",
                    icon: "error",
                    confirmButtonText: "Ya",
                    confirmButtonColor: "#b20f00",
                    showConfirmButton: true,
        ...
        $sql = "INSERT INTO tb_dokter VALUES(NULL,'$nama_dokter','$jenis_kelamin','$sip','$masa_berlaku','$spesialis','$alamat_dokter','$nomor_telp','$email','$password', '$status','$id_klinik')";
        ...
        if ($eksekusi) {
            ...
            $(document).ready(function() {
                Swal.fire({
                    text: "Registrasi Dokter berhasil!",
                    icon: "success",
                    confirmButtonText: "Ya",
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    <h3 class="fw-bold py-2 mb-3">Register Dokter</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <a class="btn batal-tambah-dokter btn-outline-primary" href="auth-register-basic.php">Batal</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
