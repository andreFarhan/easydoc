...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    ...
                    <h3 class="fw-bold py-2 mb-3">Ubah Data Dokter</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    ...
                                    <div class="mb-3">
						                ...
						                <input type="text" class="form-control" name="sip" value="<?= $data['sip']; ?>" required>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <textarea name="alamat_dokter" class="form-control"><?= $data['alamat_dokter']; ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <a class="btn batal-edit-dokter btn-outline-primary" href="dokter_show.php">Batal</a>
						            </div>
                                </div>
                            </div>
                        </form>
    ...
    <script type="text/javascript">
      $(document).on('click', '.batal-edit-dokter', function(e) {
        e.preventDefault();
        Swal.fire({
            icon: 'warning',
            title: 'Keluar',
