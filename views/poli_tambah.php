<?php 
    ...
    if (isset($_POST['submit'])) {
        if (tambahPoli($_POST) > 0 ){
            ...
            header("Location: poli_tambah.php");
            die;
        }
    }
...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    ...
                    <h3 class="fw-bold py-2 mb-3">Tambah Data Poliklinik</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="kategori_pasien" name="kategori_pasien">
                                                <option selected value="kategori" hidden>Pilih Kategori Pasien</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <textarea name="jadwal_poli" id="jadwal_poli" class="form-control" required></textarea>
                                        </div>
                                        <div class="mb-3">
                                            <label for="id_dokter" >Tambah Dokter</label>
                                            <select class="form-select" name="id_dokter" id="id_dokter" placeholder="Pilih Nama Dokter"required>
                                            <option selected value="" hidden>Pilih Nama Dokter</option>
                                        ...
                                        <div class="mb-3">
                                            <button type="submit" class="btn tambah-poli btn-primary" onclick="addPoli()" name="submit">Tambah Data</button>
    ...
    <script type="text/javascript">
      $(document).on('click', '.batal-tambah-poli', function(e) {
        e.preventDefault();
        Swal.fire({
            icon: 'warning',
            title: 'Keluar',
