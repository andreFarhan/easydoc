...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    ...
                    <h3 class="fw-bold py-2 mb-3">Tambah Data Obat</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="kategori_obat" name="kategori_obat">
                                                <option selected value="kategori" hidden>Pilih Kategori</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="jenis_obat" name="jenis_obat">
                                                <option selected value="jenis" hidden>Pilih Jenis</option>
                                                <option value="Lainnya">Lainnya</option>
                                                <option value="Lainnya">Lainnya</option>
                                        ...
                                        <div class="mb-3">
                                            ...
                                            <select class="form-select" id="satuan_obat" name="satuan_obat">
                                                <option selected value="satuan_obat" hidden>Pilih Satuan</option>
    ...
    <script type="text/javascript">
      $(document).on('click', '.batal-tambah-obat', function(e) {
        e.preventDefault();
        Swal.fire({
            icon: 'warning',
            title: 'Keluar',
