		...
		if (!empty(tambahBhp($_POST)) > 0) {
			echo '
                ...
                $(document).ready(function() {
                    Swal.fire({
                        text: "Bahan habis pakai berhasil ditambahkan!",
                        icon: "success",
			...
			echo '
                ...
                $(document).ready(function() {
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            window.location.href = "bhp_tambah.php";
                        }
                    })
                });
                </script>';
...
<body>
        ...
        <div class="layout-container">
            ...
            <div class="content-wrapper"> 
                <div class="container-xxl flex-grow-1 container-p-y"> 
                    ...
                    <h3 class="fw-bold py-2 mb-3">Tambah Data BHP</h3>
                    <div class="row">
                        <form method="POST">
                            <div class="col">
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control" name="kode_bhp" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="nama_bhp" class="font-weight-bold">Nama BHP</label>
                                            <input type="text" class="form-control" name="nama_bhp" required>
                                        </div>
                                        <div class="mb-3">
                                            <label for="stok">Stok BHP</label>
                                            <input type="number" class="form-control" id="stok_bhp" name="stok_bhp" required>
                                        </div>
                                        <div class="mb-3">
                                            <label class="form-check-label" for="satuan_bhp">Satuan BHP</label>
                                            <select class="form-select" id="satuan_bhp" name="satuan_bhp">
                                                <option selected value="satuan_bhp" hidden>Pilih Satuan</option>
                                        ...
                                        <div class="mb-3">
                                            <label for="harga_bhp">Harga BHP</label>
                                                <input type="number" class="form-control" id="harga_bhp" name="harga_bhp" required>
                                        </div>
                                        <div class="mb-3">
    ...
    <script type="text/javascript">
      $(document).on('click', '.batal-tambah-bhp', function(e) {
        e.preventDefault();
        Swal.fire({
            icon: 'warning',
            title: 'Keluar',
